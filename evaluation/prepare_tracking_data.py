...
def read_labels(path, image_index):
    ...
    with open(path, "r") as f:
        ...
        for line in csv_reader:
            data["all"].append([image_index, line[0], *line[2:6], -1, line[1], -1, -1])
            data[_CLASS_ID_MAPPING[int(line[1])]].append([image_index, line[0], *line[2:6], -1, 0, -1, -1])
    return data
...
if __name__ == "__main__":
    ...
    for input_dir, team_run_name in zip(args.input_dir, args.output_filepath):
        ...
        for label_item in label_items:
            ...
            label_filepaths = list(glob.glob(os.path.join(input_dir, label_item, "labels_ftid", "*.txt")))
